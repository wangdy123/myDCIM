...
CREATE TABLE config.DEVICE_MODEL_PARAM (
 ID INT NOT NULL,
 PROP_NAME varchar(64) NOT NULL,
 PROP_VALUE varchar(256) NOT NULL,
  PRIMARY KEY (ID,PRO_NAME),
  FOREIGN KEY (ID) REFERENCES config.DEVICE_MODEL (ID) on delete CASCADE
 )ENGINE = InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE config.SIGNAL_TRANS_FUNC (
  ...
  PRIMARY KEY (OBJECT_ID,SIGNAL_ID,SEQUENCE),
...
CREATE TABLE config.SIGNAL_TRANS_FUNC_PROP (
  ...
  VALUE varchar(64) ,
  PRIMARY KEY (OBJECT_ID,SIGNAL_ID,SEQUENCE,PROP),
  FOREIGN KEY (OBJECT_ID,SIGNAL_ID,SEQUENCE) REFERENCES config.SIGNAL_TRANS_FUNC (OBJECT_ID,SIGNAL_ID,SEQUENCE) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
