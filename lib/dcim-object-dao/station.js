...
module.exports.createUpdateTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'update config.STATION_BASE set STATION_TYPE=?,ADDRESS=?,DESCRIPTION=?,'
				+ 'LONGITUDE=?,LATITUDE=?,AREA=? where ID=?';
		connection.query(sql, [ obj.STATION_TYPE, obj.ADDRESS, obj.DESCRIPTION, obj.LONGITUDE, obj.LATITUDE, obj.AREA,
