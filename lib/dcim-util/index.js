...
module.exports.timeformat_t = function(time,fmt) {
	if(!time){
		return time;
	}
	if(!fmt){
...
module.exports.timeDiff = function(start, end) {
	...
	return module.exports.timediffFormat(Math.floor((endTime.getTime() - start.getTime()) / 1000)).toString();
};

module.exports.findFromArray=function(array,key,value){
