...
module.exports.getByPositionParent = function(pool, parentId, callback) {
	var sql = 'select o.ID,o.NAME,o.CODE,o.OBJECT_TYPE,p.PARENT_ID,r.ROOM_TYPE,'
...
module.exports.getById = function(pool, id, callback) {
	var sql = 'select o.ID,o.NAME,o.OBJECT_TYPE,o.CODE,p.PARENT_ID,r.ROOM_TYPE,'
			+ 'r.DESCRIPTION from config.OBJECT o join config.POSITION_RELATION p on o.ID=p.ID '
...
module.exports.createInsertTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'INSERT INTO config.ROOM(ID,ROOM_TYPE,DESCRIPTION)values(?,?,?)';
		connection.query(sql, [ objectId, obj.ROOM_TYPE, obj.DESCRIPTION ], function(err, result) {
...
module.exports.createUpdateTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'update config.ROOM set ROOM_TYPE=?,DESCRIPTION=? where ID=?';
		connection.query(sql, [ obj.ROOM_TYPE, obj.DESCRIPTION, objectId ],
				function(err, result) {
					callback(err, objectId);
				});
	});
