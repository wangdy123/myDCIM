...
module.exports.getByPositionParent = function(pool, parentId, callback) {
	var sql = 'select o.ID,o.NAME,o.OBJECT_TYPE,p.PARENT_ID,d.CODE,d.MODEL,d.DEVICE_TYPE,d.DESCRIPTION,'
...
module.exports.createInsertTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'INSERT INTO config.DEVICE(ID,CODE,MODEL,DEVICE_TYPE,DESCRIPTION,'
				+ 'START_USE_DATE,EXPECT_END_DATE) values(?,?,?,?,?,?,?)';
		connection.query(sql, [ objectId, obj.CODE, obj.MODEL, obj.DEVICE_TYPE, obj.DESCRIPTION, obj.START_USE_DATE,
...
module.exports.createUpdateTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'update config.DEVICE set CODE=?,MODEL=?,DEVICE_TYPE=?,DESCRIPTION=?,'
				+ 'START_USE_DATE=?,EXPECT_END_DATE=? where ID=?';
		connection.query(sql, [ obj.CODE, obj.MODEL, obj.DEVICE_TYPE, obj.DESCRIPTION, obj.START_USE_DATE,
