...
module.exports.getByPositionParent = function(pool, parentId, callback) {
	var sql = 'select o.ID,o.NAME,o.OBJECT_TYPE,p.PARENT_ID,g.CODE,g.CABINET_COUNT,'
...
module.exports.createInsertTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'INSERT INTO config.CABINET_GROUP(ID,CODE,CABINET_COUNT,CABINET_DEPTH)values(?,?,?,?)';
		connection.query(sql, [ objectId, obj.CODE, obj.CABINET_COUNT, obj.CABINET_DEPTH ], function(err, result) {
...
module.exports.createUpdateTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'update config.CABINET_GROUP set CODE=?,CABINET_COUNT=?,CABINET_DEPTH=? where ID=?';
		connection.query(sql, [ obj.CODE, obj.CABINET_COUNT, obj.CABINET_DEPTH, objectId ], function(err, result) {
			callback(err, objectId);
		});
	});
};
