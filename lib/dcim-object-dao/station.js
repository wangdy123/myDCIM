...
module.exports.getByPositionParent = function(pool, parentId, callback) {
	var sql = 'select o.ID,o.NAME,o.OBJECT_TYPE,p.PARENT_ID,s.CODE,s.STATION_TYPE,s.ADDRESS,s.DESCRIPTION,'
...
module.exports.createInsertTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'INSERT INTO config.STATION_BASE(ID,STATION_TYPE,CODE,ADDRESS,DESCRIPTION,'
				+ 'LONGITUDE,LATITUDE)values(?,?,?,?,?,?,?)';
		connection.query(sql, [ objectId, obj.STATION_TYPE, obj.CODE, obj.ADDRESS, obj.DESCRIPTION, obj.LONGITUDE,
...
module.exports.createUpdateTasks = function(connection, tasks, obj) {
	tasks.push(function(objectId, callback) {
		var sql = 'update config.STATION_BASE set STATION_TYPE=?,CODE=?,ADDRESS=?,'
				+ 'DESCRIPTION=?,LONGITUDE=?,LATITUDE=? where ID=?';
		connection.query(sql, [ obj.STATION_TYPE, obj.CODE, obj.ADDRESS, obj.DESCRIPTION, obj.LONGITUDE, obj.LATITUDE,
